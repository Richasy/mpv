...
//
// capacity_bytes: total memory budget for cached bucket payloads. Must be > 0
//                 to actually create a cache; passing 0 returns NULL (caller
//                 should treat this as "feature disabled").
// bucket_size:    size of one cache bucket. Clamped to [4 KiB, 1 MiB] and
//                 rounded up to the next power of two. Pass 0 for the default
//                 (64 KiB).
//
