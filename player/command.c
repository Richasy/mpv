...
static const struct property_osd_display {
    ...
    {"sub-stack-layout", "Sub stack layout"},
    {"sub-stack-order", "Sub stack order"},
    {"sub-stack-gap", "Sub stack gap"},
    {"sub-stack-margin", "Sub stack margin"},
...
const struct mp_cmd_def mp_cmds[] = {
    ...
    { "thumbnail-raw", cmd_thumbnail_raw,
        {
            {"time", OPT_DOUBLE(v.d)},
            {"max-width", OPT_INT(v.i), OPTDEF_INT(320)},
            {"mode", OPT_CHOICE(v.i,
                {"auto", 0},
                {"local", 1},
                {"cache", 2}),
