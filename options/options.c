...
const struct m_sub_options mp_subtitle_shared_sub_opts = {
    .opts = (const struct m_option[]){
        ...
        {"sub-pos-mode", OPT_CHOICE(sub_pos_mode[0],
            {"auto", SUB_POSITION_AUTO}, {"relative", SUB_POSITION_RELATIVE})},
        {"secondary-sub-pos-mode", OPT_CHOICE(sub_pos_mode[1],
            {"auto", SUB_POSITION_AUTO}, {"relative", SUB_POSITION_RELATIVE})},
        ...
        {"secondary-sub-ass-override", OPT_CHOICE(ass_style_override[1],
            ...
            {"strip", ASS_STYLE_OVERRIDE_STRIP}),
            .flags = UPDATE_SUB_HARD},
        {"sub-stack-layout", OPT_CHOICE(sub_stack_layout,
            {"none", SUB_STACK_NONE},
            {"bottom", SUB_STACK_BOTTOM},
            {"top", SUB_STACK_TOP},
            {"split", SUB_STACK_SPLIT})},
        {"sub-stack-order", OPT_CHOICE(sub_stack_order,
            {"primary-top", SUB_STACK_ORDER_PRIMARY_TOP},
    ...
    .defaults = &(OPT_BASE_STRUCT){
        ...
        .sub_stack_layout = SUB_STACK_NONE,
        .sub_stack_order = SUB_STACK_ORDER_PRIMARY_TOP,
        .sub_stack_gap = 10,
